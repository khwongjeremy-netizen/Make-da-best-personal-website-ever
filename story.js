...
document.querySelectorAll('.hoverable-text').forEach(el => {
    ...
    el.innerHTML = words.map(word => `<span class="inline-block hover:text-blue-400 hover:scale-105 hover:text-purple-400 transtion-all duration-300 cursor-d">${word}</span>`)
})